...
I'm currently studying for the **CFA Level I**. It's helping me understand financial markets and valuation better, and I use that when I look at and interpret data.
...
An R application that automates the creation of equity research reports, from getting the financial data to producing the final report.
 
- I built a workflow that processes financial data and generates equity research reports in PDF format automatically
- I used R Markdown to bring together financial statements, company metrics and valuation information into one reporting pipeline
- I built a Shiny app so users can view the generated reports and interact with them
...
An ETL pipeline that takes accounting data exported from Holded and turns it into clean, structured data ready for financial analysis and Power BI dashboards.
 
- I built a Python process using pandas to clean, transform and standardize accounting data from balance sheets and financial reports
- I organized the data preparation steps so the output would be consistent and easy to connect to Power BI
- I built a Power BI dashboard to track key accounting metrics and business performance
...
A SQL analytics project for a customer support ticketing system, turning raw ticket data into KPI ready data for a Power BI dashboard.
 
- I designed a relational data model for tickets and wrote three SQL queries covering case level detail, team performance and SLA tracking
- I defined the KPIs myself (first response resolution rate, productivity vs target, resolution time by category), and focused on what really shows how efficient the support team is, not just how many tickets they handled
...
A statistics project about how to evaluate business decisions using controlled A/B tests.
 
- I set up hypothesis tests to compare control and treatment groups using statistical significance methods
- I used conversion metrics, confidence intervals and other statistical methods to check the experiment results
- I turned the results into practical insights that could support a real decision
...
A predictive analytics project to find which customers are more likely to churn, and understand what really drives retention.
 
- I built and compared two classification models (Logistic Regression, Random Forest) to predict churn on an imbalanced target, only 17.8% of customers in the data actually churned
- I did exploratory data analysis and feature engineering, and paid attention to missing values that actually meant something, for example customers who never contacted support
